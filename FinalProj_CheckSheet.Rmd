...
### NOTE: ALL contents in **bold** are requirements that in our report
...
**(A) .Rmd Line numbers where at least two different data sources are imported: Line 30-31** 


**(B) .Rmd Line numbers for inspecting data intake: Line 39-40** 
...
**(A) .Rmd Line number(s) for general data wrangling: Line 52-57** 


**(B) .Rmd Line number(s) for a join operation: Line 65-66**


**(C) .Rmd Line number(s) for a spread or gather operation (or equivalent): Line 74-77**


**(D) .Rmd Line number(s) for use of regular expressions: Line 85-86**


**(E) .Rmd Line number(s) for use of reduction and/or transformation functions: Line 94**
...
**(A) .Rmd Line number(s) for use of mulitple different geoms: Line 108**

**(B) .Rmd Line number(s) for use of multiple aesthetics: Line 123, 139**

**(C) .Rmd Line number(s) for use of layered graphics: Line 141**
