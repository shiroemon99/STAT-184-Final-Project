...
##### (A) General Data Wrangling (using `group_by()` and `summarise()`): Line 50-55 
...
##### (B) Joins for multiple data tables: Line 63-64
...
##### (C) Stack varibales by `gather()`: Line 71-75
...
##### (D) Regular expressions: Line 83-84
...
##### (E) Reduction/transformation functions: Line 92

```{r}
rank(druguse_20172018$duq220u)
```
...
##### Use of multiple geoms: Line 106
...
##### (B) Use of multiple aesthetics: Line 121, 137
